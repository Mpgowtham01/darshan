...
export default function CommunityIncharge() {
  const [originalData, setOriginalData] = useState([]);
  const [filteredData, setFilteredData] = useState([]);
  const { groupName } = useParams();
  const [show, setShow] = useState(false);
  const [details, setDetails] = useState();
  console.log('firstdetails', details)
  ...
  const matrimonialData = () => {
    axios
      .get(
        `${process.env.REACT_APP_DEV_BASE_URL}/communityTemple/getCurrentTempleincharge`,
          ...
          <div>
            <FontAwesomeIcon
              ...
              onClick={() => {
                ...
                navigate(`/community/${groupName}/AddcommunityIncharge`, {
                  state: {
                    ...record,
                  },
                  // replace: true,
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Incharge Details</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          <div className="d-flex mb-3">
           ...
           <div className="d-flex mb-3">
            ...
            <Col>
              <p className="mb-0">&nbsp;{details?.role}</p>
            </Col>
          </div>
