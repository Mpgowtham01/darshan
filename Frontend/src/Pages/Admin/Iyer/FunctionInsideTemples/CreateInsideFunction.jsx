...
export default function CreateFunctionInsideTheTemple() {
    ...
    const displayToaster = () => {
        ...
        setTimeout(() => { navigate("/admin/inside-temple"); }, 1000);
    };
    ...
    const onSubmit = async (data, e) => {
        try {
            if (locationState) {
                ...
                //create
                await axios.post(`${process.env.REACT_APP_DEV_BASE_URL}/priestFunction/create`, { ...data, function_type: 1 });
                displayToaster();
            }
        } catch (error) {
    ...
    return (
        <div className="createListForm">
            ...
            <Container>
                <h1 className="createListForm__title">Add function inside the temple</h1>
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        <Form.Group className="mb-3">
                            ...
                            <div className="field-style-2">
                                ...
                                <Form.Text style={{ color: "red" }}>{errors?.FunctionInsideTheTemple && "This is required"}</Form.Text>
                            </div>
                        </Form.Group>
