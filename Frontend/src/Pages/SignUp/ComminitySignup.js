...
const CommunitySignUp = () => {
  ...
  const [selectkuladeivamArea, setselectkuladeivamArea] = useState("");
  ...
  console.log(
    "🚀 ~ file: ComminitySignup.js:97 ~ registerResponse",
    registerResponse
  );
  ...
  return (
    <div>
      <ToastContainer position="top-center">
        <Toast onClose={() => showToast()} show={show}>
          <Toast.Header>
            <strong
        ...
        <div>
          <Formik
            ...
            onSubmit={(values, actions) => {
              ...
              setShow(true);
              // setkuladeivamName("");
              // setselectkuladeivamCountry("");
              // setselectkuladeivamState("");
              // setselectkuladeivamDistrict("");
              // setselectkuladeivamCity("");
              // setkuladeivamAddress("");
              // setselectGroupName("");

              actions.resetForm({
                values: {
                  kuladeivamName: "",
                  selectkuladeivamCountry: "",
                  selectkuladeivamState: "",
                  selectkuladeivamDistrict: "",
                  selectkuladeivamCity: "",
                  kuladeivamAddress: "",
                  selectGroupName: "",
                },
              });
