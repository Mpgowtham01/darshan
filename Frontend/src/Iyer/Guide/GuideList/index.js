...
export default function GuideList() {
  ...
  const [classlist, setclasslist] = useState(guidelist);
  ...
  const getGuideDetails =()=>{
    const id = params.id
    axios
    .get(`${process.env.REACT_APP_DEV_BASE_URL}/guidelist/getone/${id}`)
    .then((res) => {
                  ...
                  <Card style={{ height: "100%" }}>
                    <Card.Body>
                      <div className="row">
                        ...
                        >
                          <h6 className="mb-1">{list.guideName}</h6>
                          <p className="ellipse-text mb-0">
                            {list.guideDescription}
                          </p>
                        </Col>
                      </div>
                      <hr />
                      ...
                      <div className="d-flex justify-content-end mt-3 mb-2 me-3">
                        <Link
                          to={`/bookmyiyer/guide/details/${index}`}
